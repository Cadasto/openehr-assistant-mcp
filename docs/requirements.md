...
| **REQ-N10** | Install documentation for this server is canonical here, stays at a stable path, and is consumable by external documentation without being copied. | The public website publishes it by fetching this file at a released tag, so a rename or a restructured hosted-endpoint section breaks a published page. → [ADR-0007](decisions/0007-website-in-separate-repository.md) |
