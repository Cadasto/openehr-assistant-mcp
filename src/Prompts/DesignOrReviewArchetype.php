...
readonly final class DesignOrReviewArchetype extends AbstractPrompt
{
     ...
     *
     * @param mixed $task_type design | review | specialise-existing
     * @param mixed $concept Archetype concept
     * @param mixed $rm_type Target RM type
     * @param mixed $clinical_context Clinical use context
     * @param mixed $existing_archetype Existing Archetype (ADL or URI) — optional for design, expected when task_type is review
     * @param mixed $parent_archetype Parent Archetype — optional for design, expected when task_type is specialise-existing
